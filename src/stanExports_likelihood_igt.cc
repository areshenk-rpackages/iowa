...
#include "stanExports_likelihood_igt.h"

RCPP_MODULE(stan_fit4likelihood_igt_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_likelihood_igt")
